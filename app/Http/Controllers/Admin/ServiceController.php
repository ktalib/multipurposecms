...
class ServiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'publication_file' => 'required|mimetypes:application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document',
...
$fileToStore = null; // Initialize variable to store the file path
if ($request->hasFile('publication_file')) {
    // Retrieve file with original name and extension
    ...
    $file->move($filePath, $fileToStore);
}

// Handle content and images logic (unchanged) ...
...
$service->publication_type = $request->publication_type;

// Save the file path if a file was uploaded
if ($fileToStore) {
    $service->publication_file = 'uploads/files/' . $fileToStore;
}
