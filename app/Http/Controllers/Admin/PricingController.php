    ...
    public function store(Request $request) 
{
    ...
    $request->validate([
        ...
        'book_cover' => 'required|image', // Ensure it's an image file
    ...
    if ($request->hasFile('book_cover')) {
        ...
        $path = $request->file('book_cover')->store('public/pricing');

        // Extract the filename from the stored path
        $fileName = basename($path);

        // Assign the filename to the model property
        $pricing->book_cover = $fileName;
    }
