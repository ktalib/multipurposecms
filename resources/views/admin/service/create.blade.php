        ...
        <div class="col-12 col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="title">Publication Type <span>*</span></label>
                    ...
                    <div class="form-group">
                        <label for="image">Publication file <span> (pdf, doc, docx)</span></label>
                        <input type="file" class="form-control" name="publication_file" id="image" required>
